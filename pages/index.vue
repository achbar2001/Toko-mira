  ...
  <div class="mr-custom mb-5">
    <div class="fade-in">
      ...
      <div class="container-fluid mt-4 mb-5">
        <div class="mb-4">
          <h5 class="text-uppercase font-weight-bold"><i class="fa fa-shopping-bag"></i> PRODUK TERBARU</h5>
          <!-- Solid divider -->
          <hr class="solid">
        </div>
        <div class="row">
        ...
        <div class="row justify-content-center mt-4">
          <div class="text-center">
            <nuxt-link :to="{ name: 'products' }" class="btn btn-lg btn-info border-0 rounded shadow-sm">LIHAT LEBIH
              BANYAK</nuxt-link>
          </div>
        </div>
  ...
  head() {
    return {
      ...
      meta: [{
        hid: 'og:title',
        name: 'og:title',
        content: 'Toko Mira - E-Commerce Fashion'
      },
      {
        hid: 'og:site_name',
        name: 'og:site_name',
      ...
      },
      {
        hid: 'og:image',
        name: 'og:image',
        content: 'images/logomira.jpg'
      },
      {
        hid: 'description',
        name: 'description',
        content: 'Official Toko Online Penjualan Produk Toko Mira'
      },
      ]
    }
  },
