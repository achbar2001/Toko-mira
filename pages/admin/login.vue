<template>
    <div class="fade-in">
        <div class="text-center mb-4">   
                <img src="/images/logomira.jpg" class="img-logoadmin" width="100px"> 
                <h3 class="mt-2 font-weight-bold">ADMIN MIRA STORE </h3> 
        </div>
            ...
            <div class="card border-top-orange border-0 shadow-sm rounded">
                <div class="card-body">
                    ...
                    <form @submit.prevent="login">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-info shadow-sm rounded-sm px-4 w-100"
